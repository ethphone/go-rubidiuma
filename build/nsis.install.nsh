Name "grbd ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/rubidiumchain/go-rubidiuma/issues"
!define UPDATEURL "https://github.com/rubidiumchain/go-rubidiuma/releases"
!define ABOUTURL "https://github.com/rubidiumchain/go-rubidiuma#ethereum-go"
...
# Install grbd binary
Section "Grbd" GETH_IDX
  SetOutPath $INSTDIR
  file {{.Grbd}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\grbd.exe" "--fast" "--cache=512"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\grbd.exe" "attach" "" ""
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe" "" "" ""

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "Grbd incoming peers (TCP:33460)"
  SimpleFC::AdvRemoveRule "Grbd outgoing peers (TCP:33460)"
  SimpleFC::AdvRemoveRule "Grbd UDP discovery (UDP:33460)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Grbd incoming peers (TCP:33460)" ""  6 1 1 2147483647 1 "$INSTDIR\grbd.exe" "" "" "Ethereum" 33460 "" "" ""
  SimpleFC::AdvAddRule "Grbd outgoing peers (TCP:33460)" ""  6 2 1 2147483647 1 "$INSTDIR\grbd.exe" "" "" "Ethereum" "" 33460 "" ""
  SimpleFC::AdvAddRule "Grbd UDP discovery (UDP:33460)" "" 17 2 1 2147483647 1 "$INSTDIR\grbd.exe" "" "" "Ethereum" "" 33460 "" ""

  # Set default IPC endpoint (https://github.com/ethereum/EIPs/issues/147)
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "R" "HKLM" "\\.\pipe\grbd.ipc"
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "A" "HKLM" "\\.\pipe\grbd.ipc"
