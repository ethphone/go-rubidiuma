...
GLOBAL OPTIONS:
   ...
   --keystore value        Directory for the keystore (default: "$HOME/.rubidium/keystore")
...
The general flow for signing a transaction using e.g. Grbd is as follows:
![image](sign_flow.png)

In this case, `grbd` would be started with `--signer http://localhost:8550` and would relay requests to `eth.sendTransaction`.
...
* Another potential thing to introduce is pairing.
  ...
  * Thus Grbd/cpp would cryptographically handshake and afterwards the caller would be allowed to make signing requests.
  ...
  "params": [
    {
      "accounts": [
        {
          "type": "Account",
          "url": "keystore:///home/bazonk/.rubidium/keystore/UTC--2017-11-20T14-44-54.089682944Z--123409812340981234098123409812deadbeef42",
          "address": "0x123409812340981234098123409812deadbeef42"
        },
        {
          "type": "Account",
          "url": "keystore:///home/bazonk/.rubidium/keystore/UTC--2017-11-23T21-59-03.199240693Z--cafebabedeadbeef34098123409812deadbeef42",
