...
|   `puppeth`   | a CLI wizard that aids in creating a new Rubidium network.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
As a developer, sooner rather than later you'll want to start interacting with `grbd` and the
