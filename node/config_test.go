...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "grbd.ipc", false, filepath.Join(os.TempDir(), "grbd.ipc")},
		{"data", "grbd.ipc", false, "data/grbd.ipc"},
		{"data", "./grbd.ipc", false, "./grbd.ipc"},
		{"data", "/grbd.ipc", false, "/grbd.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "grbd.ipc", true, `\\.\pipe\grbd.ipc`},
		{"data", "grbd.ipc", true, `\\.\pipe\grbd.ipc`},
		{"data", `\\.\pipe\grbd.ipc`, true, `\\.\pipe\grbd.ipc`},
	}
